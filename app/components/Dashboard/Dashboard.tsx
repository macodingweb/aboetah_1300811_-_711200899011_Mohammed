      ...
      <div className="content relative w-[100%] mr-[30px]">
        <div className="card-group main-grid">
          <div onClick={() => setCardA(!cardA)} className="card p-6 border-solid border-[2px] border-black bg-white rounded-[8px] main-shadow-lg main-shadow-lg-hover transition-all">
            <div className="info flex items-center justify-between pb-5 border-solid border-x-0 border-y-0 border-b-[1px] border-black">
              <span className="text-[22px] font-[700] main-text-shadow">
                عدد العملاء
              </span>
              <div className="icon w-[28px]">
            ...
            <div style={cardA ? {filter: "blur(0)"} : {filter: "blur(12px)"}} className="value select-none text-center text-[24px] font-bold text-slate-800 my-8 blur-[10px]">
        ...
        <div className="btn-group mt-[30px]">
          <Link
            ...
            className="btn w-[350px] flex justify-between border-solid border-[2px] border-black transition-all cursor-pointer items-center p-4 rounded-[4px] bg-white main-shadow-lg main-shadow-lg-hover"
          >
            <span className="text-[26px] font-semibold">إضافة قسط</span>
            <div className="icon w-[28px]">
