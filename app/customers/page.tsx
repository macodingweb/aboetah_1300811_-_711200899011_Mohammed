                ...
                {Array.isArray(customers) && customers.length > 0 ? (
                  customers.map((customer, index) => (
                    <tr key={index}>
                      ...
                      <th>
                        <Link href={`/auth/edit-customer?name=${customer.name}&telephone=${customer.telephone}&customerId=${customer.unique_id}&status=${customer.status}&address=${customer.address}`} className="w-[40px] block">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
